  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', paddingTop: 8 }}>
        ...
        <div style={{ fontSize: 32, fontWeight: 900, color: '#FFFFFF', lineHeight: 1.1 }}>
          CAN'T DECIDE?
        </div>
        <div style={{
          fontSize: 32, fontWeight: 900, lineHeight: 1.1, marginBottom: 8,
          background: gr(135), WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
        }}>
          WE GOT YOU.
        </div>
      ...
      <button
        ...
        style={{
          ...
          padding: '17px 24px', color: '#FFFFFF', fontSize: 16,
      ...
      >
        ...
        <span style={{ color: C.muted, fontSize: 18, marginLeft: 'auto' }}>›</span>
      </button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: '#FFFFFF' }}>
              Pizza vs Sushi · <span style={{ color: '#EC4899' }}>847 votes</span>
            </div>
