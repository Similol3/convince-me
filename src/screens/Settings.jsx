...
export default function Settings({ user, onSignOut }) {
  ...
  return (
    ...
    >
      <div>
        <h1
          style={{ fontSize: 28, fontWeight: 900, color: "white", margin: 0 }}
        >
          Settings
        </h1>
        <p
      ...
      {showConfirm && (
        ...
        >
          ...
          >
            ...
            >
              This will permanently delete all your decisions, battles, and
              Connect history. This can't be undone.
            </p>
