      ...
      {step === 'input' && situation && (
        <>
          <button onClick={() => setStep('pick')} style={{
            ...
            padding: 0, textAlign: 'left', display: 'flex',
              ...
              {!image ? (
                ...
                <div style={{ position: 'relative' }}>
                  <img src={image} alt="Story" style={{
                    width: '100%', borderRadius: 16, maxHeight: 280,
          ...
          <div style={{
            ...
            <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.1em',
              ...
              {situation.id === 'reply_text' ? "WHAT DID THEY SAY?" : "CONTEXT (OPTIONAL)"}
            </p>
            <textarea
              value={context}
              onChange={e => setContext(e.target.value)}
              placeholder={
                situation.id === 'reply_story' ? "e.g. It's a beach photo from their trip..."
                : situation.id === 'start_chat' ? "e.g. We both like gaming, met at school..."
        ...
        <>
          ...
          <div style={{
            ...
            {loading ? (
              ...
              <div>
                <div style={{ fontSize: 30, marginBottom: 12 }}>{situation.emoji}</div>
                <p style={{ fontSize: 17, fontWeight: 700, color: 'white', lineHeight: 1.5, margin: 0 }}>
                  "{picked}"
                </p>
              </div>
            )}
          ...
          {!loading && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <button onClick={reset} style={{
                ...
                fontFamily: 'inherit', padding: '8px', textAlign: 'center',
              }}>
                Start Over
              </button>
            </div>
              ...
              {getConnectHistory().map(item => (
                <div key={item.id} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ fontSize: 16 }}>{item.situationEmoji}</span>
