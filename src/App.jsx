    ...
    return (
      <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: 430 }}>
          ...
          {authScreen === 'forgot' && <ForgotPassword onSwitch={setAuthScreen} />}
        </div>
      </div>
    );
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 110 }}>
          ...
          {screen === 3  && (
            <Reveal optA={optA} optB={optB} answers={answers}
              user={user} category={category} go={go} onDecided={handleDecided} />
          )}
